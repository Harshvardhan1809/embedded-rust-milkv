...
use crate::one_wire_bus::one_wire::{OneWire, READ_SLOT_DURATION_MICROS};
use crate::one_wire_bus::error::{OneWireError, OneWireResult};

pub const FAMILY_CODE: u8 = 0x28;

use crate::ds18b20::commands;
use crate::ds18b20::resolution::Resolution;

use crate::one_wire_bus::crc::check_crc8;
...
impl Ds18b20 {
    ...
    pub fn new(address: Address) -> OneWireResult<Ds18b20> {
